...
[![Travis build status](https://travis-ci.com/delabj/scryAnotherDay.svg?branch=master)](https://travis-ci.com/delabj/scryAnotherDay)
...
This package is very much in the alpha stages, the API may change and breaking changes could be introduced. This package is not maintained nor endorsed by scryfall.com, but is build according to the rules provided in their licence.  
